...
void ForceSolver::ForceGravity(Circle& c1, Circle& c2)
 {
        ...
        Vec2 F12 = dir_12 * (m_Gravity * m1 * m2 / (d * d)) / length(dir_12);
...
void ForceSolver::FallGravity(Circle &c, float gravity,  float dt)
{
