...
public:
    ...
    /*
        check and react collision with border (edge of physics world)
    */
    ...
    */
    ...
    /*
        find mininmum and maximum points projection on axis
    */
    ...
    */
    ...
    static void applyCollisionReaction(Rect& rectA, Rect& rectB, Vec2 normal, Vec2 contactPoint, float depth);
    static void applyCircleRectCollision(Circle& circle, Rect& rect, Vec2 normal, Vec2 contactPoint, float depth);
};
